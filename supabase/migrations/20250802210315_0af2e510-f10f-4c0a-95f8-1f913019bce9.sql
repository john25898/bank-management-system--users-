...
-- Remove old loan-specific columns and add medicine-specific ones
...
ALTER TABLE public.medicine_requests 
  ADD COLUMN generic_name TEXT NOT NULL,
  ADD COLUMN brand_name TEXT,
  ADD COLUMN alternative_names_accepted BOOLEAN DEFAULT false,
  ADD COLUMN strength_dosage TEXT NOT NULL,
  ADD COLUMN form_type TEXT NOT NULL,
  ADD COLUMN quantity_units INTEGER NOT NULL,
  ADD COLUMN days_treatment INTEGER NOT NULL,
...
ALTER TABLE public.medicine_requests 
  ...
  ADD COLUMN prescription_status TEXT NOT NULL;
...
ALTER TABLE public.medicine_requests 
  ...
  ADD COLUMN return_method TEXT NOT NULL;
